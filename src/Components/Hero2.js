    ...
    <section className="w-full gap-10 py-10 md:px-10  md:py-20 relative px-0 pb-20 md:pt-8">
      ...
      >
        ...
        <p className="text-zinc-600">
          Visibility into when a feature is ready for testing or available on prod.
        </p>
      </button>
      <button
        className={`w-full rounded-3xl px-8 py-6 text-left ${
          activeButton === 'update' ? 'hover:bg-zinc-100 bg-zinc-100' : 'hover:bg-gray-100'
        }`}
      ...
      >
        ...
        <p className="text-zinc-600">
          An automated change feed your stakeholders can actually understand.
        </p>
      </button>
      <button
        className={`w-full rounded-3xl px-8 py-6 text-left ${
          activeButton === 'save' ? 'hover:bg-zinc-100 bg-zinc-100' : 'hover:bg-gray-100'
        }`}
      ...
      >
        ...
        <p className="text-zinc-600">
          Beautifully formatted changelog posts you can create, publish, and share.
        </p>
      </button>
    </div>
      </div>
